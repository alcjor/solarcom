...
public class LatLonBody extends space.Body {
    ...
    protected void initOperationMap() {
        ...
        elevationOpMap.put(ClassTuple.of(LatLonBody.class, KernelBody.class), (x,y, ref) -> {
            return elevationKernel((LatLonBody) x, (KernelBody) y, (boolean) ref);
        });
    ...
    protected double elevationKernel(LatLonBody thisBody, KernelBody other, boolean refraction) {
