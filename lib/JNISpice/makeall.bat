...
rem for the JNISpice package of the toolkit.
rem
rem The script must be executed from the
rem JNISpice directory.
rem
cd src
rem
rem Creating cspice
...
cd ..
rem
rem Creating tutils_c
rem
cd tutils_c
call mkprodct.bat
cd ..
rem
rem Creating JNISpice
rem
cd JNISpice
call mkprodct.bat
cd ..
...
cd ..
rem
rem Creating dskbrief_c
rem
cd dskbrief_c
call mkprodct.bat
cd ..
rem
rem Creating dskexp_c
rem
cd dskexp_c
call mkprodct.bat
cd ..
